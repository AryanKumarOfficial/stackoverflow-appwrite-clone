...
import {account} from "@/Models/client/config"; // Ensure this import path is correct
...
export default function Register() {
    ...
    return (
        <div
            className="mx-auto w-full max-w-md rounded-none border border-solid border-white/30 bg-white p-4 shadow-input dark:bg-black md:rounded-2xl md:p-8">
