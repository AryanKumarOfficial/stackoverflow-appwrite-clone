  ...
  try {
    ...
    return {
      ...
      description:
        ...
        "View question and answers on Riverflow Q&A",
    };
  } catch {
    return {
  ...
  try {
      ...
      Promise.all(
        comments.documents.map(async (comment) => {
          ...
          try {
            ...
            console.error(
              `Failed to get comment author for comment ${comment.$id}:`,
              error,
            );
            commentAuthor = {
              $id: "unknown",
      ...
      Promise.all(
        answers.documents.map(async (answer) => {
          ...
          try {
            ...
            console.error(
              `Failed to get data for answer ${answer.$id}:`,
              error,
            );
          ...
          comments.documents = await Promise.all(
            comments.documents.map(async (comment) => {
              ...
              try {
                ...
                console.error(
                  `Failed to get comment author for answer comment ${comment.$id}:`,
                  error,
                );
                commentAuthor = {
                  $id: "unknown",
            ...
            <div className="w-full">
              ...
              <div className="flex gap-4 text-sm">
                <React.Fragment>
                  ...
                  <span
                    className={`${answers.total > 0 ? "font-bold text-green-500" : ""}`}
                  >
    ...
    return (
      <div className="container mx-auto mt-10 p-4">
        ...
        <p>
          Failed to load the question. It may have been deleted or you don't
          have permission to view it.
        </p>
        <div className="mt-4">
          <a href="/questions" className="text-blue-500 hover:underline">
            Back to Questions
          </a>
        </div>
      </div>
